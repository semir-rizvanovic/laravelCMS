...
class BrandController extends Controller
{
    ...
    public function storebrand(Request $request) {
        ...
        if($image) {
            ...
            $notification=array(
                'messege'=>'Uspješno ste dodali brend.',
                'alert-type'=>'success'
                 );
    ...
    public function deletebrand($id) {
        ...
        $notification=array(
            'messege'=>'Uspješno ste obrisali brend.',
            'alert-type'=>'success'
             );
           return Redirect()->back()->with($notification);
    }
    ...
    public function updatebrand(Request $request, $id) {
        ...
        if($image) {
            ...
            $notification=array(
                'messege'=>'Uspješno ste izmjenili brend.',
                'alert-type'=>'success'
                 );
            ...
            $brand = DB::table('brands')->where('id', $id)->update($data);
            $notification=array(
                'messege'=>'Promjenili ste samo Naziv brenda (bez slike).',
                'alert-type'=>'success'
                 );
               return Redirect()->route('brands')->with($notification);
