    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Lista brendova
          <a href="#" class="btn btn-sm btn-success" style="float: right;" data-toggle="modal" data-target="#modaldemo3">Dodaj Brend</a>
          </h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-25p">Naziv Brenda</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ URL::to('edit/brand/'.$row->id) }}" class="btn btn-sm btn-info">Uredi</a>
                    <a href="{{ URL::to('delete/brand/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Obriši</a>
                  </td>
                </tr>
                @endforeach
